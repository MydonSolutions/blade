...
void NB_SUBMODULE_READER(auto& m, const auto& name, const auto& typeName) {
    ...
    mod
        ...
        .def("get_observation_bandwidth", &Class::getObservationBandwidth)
        .def("get_channel_bandwidth", &Class::getChannelBandwidth)
        .def("get_channel_timespan", &Class::getChannelTimespan)
        .def("get_channel_start_Index", &Class::getChannelStartIndex)
        .def("get_observationCenter_frequency", &Class::getObservationCenterFrequency)
        .def("get_center_frequency", &Class::getCenterFrequency)
        .def("get_observation_bottom_frequency", &Class::getObservationBottomFrequency)
        .def("get_bottom_frequency", &Class::getBottomFrequency)
        .def("get_observation_top_frequency", &Class::getObservationTopFrequency)
        .def("get_top_frequency", &Class::getTopFrequency)
        .def("get_bandwidth", &Class::getBandwidth)
        .def("get_azimuth_angle", &Class::getAzimuthAngle)
        .def("get_zenith_angle", &Class::getZenithAngle)
        .def("get_right_ascension", &Class::getRightAscension)
        .def("get_declination", &Class::getDeclination)
        .def("get_phase_right_ascension", &Class::getPhaseRightAscension)
        .def("get_phase_declination", &Class::getPhaseDeclination)
        .def("get_source_name", &Class::getSourceName)
        .def("get_telescope_name", &Class::getTelescopeName)
